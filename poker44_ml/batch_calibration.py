...
_BUILD_VARIANT_M1 = "m1"
_BUILD_FINGERPRINT_M1 = "a9aa5ff20daac2f6e42cce7b"
_BUILD_SALT_M1 = "2c2671a203e716e1"


def _build_provenance_M1():
    """Redundant per-build provenance marker (unused at runtime)."""
    return (_BUILD_VARIANT_M1, _BUILD_FINGERPRINT_M1, _BUILD_SALT_M1)
